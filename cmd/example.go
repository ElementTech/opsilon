...
import (
	...
	"github.com/amitai-devops/gitform/internal/convert"
	"github.com/amitai-devops/gitform/pkg/example"
	"github.com/spf13/cobra"
)

const (
	exampleNumberOfArgs = 2
)
...
func newExampleCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		SilenceUsage: true,
		Args:         cobra.ExactArgs(exampleNumberOfArgs),
		RunE:         o.run,
	}
